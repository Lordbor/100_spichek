...
void game(sf::RenderWindow& window) 
{
	...
	while (isGame) 
	{
		...
		while (window.pollEvent(event))
		{
			...
			{
				if (event.mouseButton.button == sf::Mouse::Left && sf::IntRect(75, 303, 42, 75).contains(sf::Mouse::getPosition(window)))
				{
				...
				if (event.mouseButton.button == sf::Mouse::Left && sf::IntRect(119, 303, 47, 75).contains(sf::Mouse::getPosition(window)))
				{
				...
				if (event.mouseButton.button == sf::Mouse::Left && sf::IntRect(170, 303, 40, 75).contains(sf::Mouse::getPosition(window)))
				{
				...
				if (event.mouseButton.button == sf::Mouse::Left && sf::IntRect(215, 303, 40, 75).contains(sf::Mouse::getPosition(window)))
				{
				...
				if (event.mouseButton.button == sf::Mouse::Left && sf::IntRect(260, 303, 44, 75).contains(sf::Mouse::getPosition(window)))
				{
				...
				if (event.mouseButton.button == sf::Mouse::Left && sf::IntRect(306, 303, 44, 75).contains(sf::Mouse::getPosition(window)))
				{
				...
				if (event.mouseButton.button == sf::Mouse::Left && sf::IntRect(354, 303, 44, 75).contains(sf::Mouse::getPosition(window)))
				{
				...
				if (event.mouseButton.button == sf::Mouse::Left && sf::IntRect(402, 303, 44, 75).contains(sf::Mouse::getPosition(window)))
				{
				...
				if (event.mouseButton.button == sf::Mouse::Left && sf::IntRect(449, 303, 44, 75).contains(sf::Mouse::getPosition(window)))
				{
				...
				if (event.mouseButton.button == sf::Mouse::Left && sf::IntRect(499, 303, 50, 75).contains(sf::Mouse::getPosition(window)))
				{
